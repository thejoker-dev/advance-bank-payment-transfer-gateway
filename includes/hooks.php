...
function abpt_gateway_plugin_links($links)
{
    ...
    $plugin_links = array(
        '<a href="' . admin_url('admin.php?page=wc-settings&tab=checkout&section=offline_gateway') . '">' . __('Configurar', 'wc-gateway-offline') . '</a>'
    );
...
add_action('wp_ajax_abpt_ajax_process_request', 'abpt_ajax_process_request');
add_action('wp_ajax_nopriv_abpt_ajax_process_request', 'abpt_ajax_process_request'); // If you are handling AJAX requests from unauthenticated users.
